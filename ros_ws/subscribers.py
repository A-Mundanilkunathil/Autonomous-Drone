"""
Subscribers receive data FROM the drone via MAVROS and perception nodes
"""
import rclpy
...
class MavrosSubscribers:
    def __init__(self, node: Node):
        ...
        node.get_logger().info('MAVROS and Perception Subscribers initialized.')
